...
import logoImage from "../../assets/logoimage.png"; // Import the logo image

const Home = () => {
    const heading = "Your Personal Finanace Assistant";
    ...
    const handleSearchClick = () => {
        navigate("/dashboard"); // changed from "/main"
    };

    return (
        <div className={styles.container}>
            {/* Add random lines container */}
            ...
            >
                ...
                <div className={styles.glassOverlay}>
                    ...
                    <div className={styles.heroImage}>
                        <img src={image} alt="Finance Assistant" />
                    </div>
                </div>
            ...
            <section className={styles.howItWorks}>
                ...
                <div className={styles.howItWorksSteps}>
                    {[1, 2, 3, 4].map((step) => (
                        ...
                        >
                            <div className={styles.stepIcon}>{step}</div>
                            ...
                            <p className={styles.stepDescription}>
                                {step === 1
                                    ...
                                    : "Execute trades or adjust your portfolio."}
                            </p>
                        </motion.div>
                    ))}
                </div>
...
// New Button component based on provided code
const Button = () => {
  const navigate = useNavigate();
